...
/* select tag component that has all country codes */
const CountryCodes = (props) =>{
    return(
        <select id="country_list" defaultValue={'+91'} onChange={props.handleChange("country_code")}>
            ...
            <option data-countrycode="IN" value="+91" defaultValue>India (+91)</option>
